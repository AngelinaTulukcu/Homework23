...
public class OrderPage {
    ...
    public void clickSignInButtonAndNavigateToOrder() {
    }

    public void enterUsername(String newOrder) {
    }

    public void enterPhoneNumber(String s) {
    }

    public void enterComment(String today) {
    }

    public void clickCreateOrderButton() {
    }

    public void waitForOrderCreationConfirmation() {
    }

    public void clickStatusButtonToSearchOrder() {
    }

    public void enterSearchOrderNumber(String number) {
    }

    public void clickSearchOrderButton() {
    }

    public void verifyOrderNotFoundError() {
    }
}